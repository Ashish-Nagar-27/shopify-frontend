...
export const ALL_COLUMNS: ColumnDef[] = [
  ...
  { key: "nCPA", label: "nCPA", width: 100, num: true, group: "Cost" },
  { key: "CPC", label: "CPC", width: 80, num: true, group: "Cost" },
  { key: "nCPC", label: "nCPC*", width: 100, num: true, group: "Cost" },
  ...
  { key: "Sales", label: "Sales", width: 90, num: true, group: "Revenue" },
  {
    key: "Reported Sale",
    label: "ReportedSale",
    width: 160,
  ...
  // Funnel Group
  { key: "ATC", label: "ATC", width: 110, num: true, group: "Funnel" },
  {
    key: "checkout",
    label: "Checkout",
    width: 100,
